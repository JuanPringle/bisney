...
function AISuggestion({ term }: { term: string }) {
    ...
    const generateText = () => {
        ...
        return (
            <>
                <div className='animate-pulse rounded-full bg-gradient-to-t from-white h-10 w-10 border-2 flex-shrink-0 border-white'></div>
                <div>
                    <p className='text-sm text-gray-400'>AI (Azure Functions) Assistant Suggests:{" "}</p>
