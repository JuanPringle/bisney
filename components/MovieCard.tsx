...
function MovieCard({movie}: {movie:Movie}) {
  return (
    ...
    transition duration-200 ease-out hover:drop-shadow-lg'>
      ...
      from-gray-200/0 via-gray-900/10 to-gray-300 dark:to-[#1A1C29]/80 z-10'
      />
      <p className='absolute z-20 bottom-5 left-5'>{movie.title}</p>
      <Image
      className='w-fit lg:min-w-[400px] h-56 object-cover show-md shadow-gray-900 drop-shadow-xl rounded-sm'
